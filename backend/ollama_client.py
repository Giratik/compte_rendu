...
URL_OLLAMA = os.environ.get("OLLAMA_HOST", "http://10.75.12.5:11434")
client = Client(host=URL_OLLAMA)

def inferring_ollama(messages, model, temperature=0.4, stream=False, context_size=32768, seed = None, keep_alive = -1):
